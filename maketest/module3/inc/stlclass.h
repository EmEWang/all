#ifndef __MODULE3_STLCLASS_H__
#define __MODULE3_STLCLASS_H__
...
// 如果程序员没有显式地为一个类定义某个特殊成员函数，而又需要用到该特殊成员函数时，
...
inline X2::X2(const X2&) = default;  //Out-of-line defaulted 拷贝构造函数
inline X2& X2::operator= (const X2&) = default;   //Out-of-line defaulted  拷贝赋值操作符
