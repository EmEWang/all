...
if __name__ == '__main__':
    ...
    parser.add_argument('--svg', default=None, help='The output .svg path.')
    parser.add_argument('--text', default=None, help='The output .txt path.')
    parser.add_argument('--flame', default=None, help='The Flame path.')
    ...
    if args.text:
        res.write_text_output(Path(args.text))
    if args.svg:
        res.write_svg_ouput(Path(args.svg), args.flame)